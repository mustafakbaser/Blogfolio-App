  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: 'YOUR-WEB3FORMS-ACCESS-KEY', // Web3Forms'dan alınacak
          name: formData.name,
      ...
      <main className="flex-grow bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white rounded-2xl shadow-sm p-8 order-2 md:order-1">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">iletisim@mustafabaser.net</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">+90 (XXX) XXX XX XX</p>
                    </div>
                  </div>
