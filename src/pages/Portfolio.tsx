                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.map((tag, tagIndex) => (
                      <span 
                        key={tagIndex}
                        className="px-3 py-1 text-sm font-medium bg-indigo-50 text-indigo-600 rounded-full"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-2 bg-indigo-50 rounded-lg">
                      <tech.icon className="w-6 h-6 text-indigo-600" />
                    </div>
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center p-1 rounded-full bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600">
              <a 
                ...
                className="px-8 py-3 bg-white rounded-full text-lg font-medium text-gray-900 hover:bg-gray-50 transition-colors"
              >
                Birlikte Çalışalım
              </a>
            </div>
